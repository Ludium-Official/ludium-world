...
export default function NewApplyForm() {
    ...
    return <form className={applystyle.form} onSubmit={handleApplyForm} >
        ...
        <div className={applystyle["form-header"]}>
            <input className={applystyle.title} type="text" name="title" defaultValue="" placeholder="지원서 제목을 입력해주세요" />
        </div>
        <div className={applystyle["form-content-area"]}>
            <Editor editorRef={editorRef} height="100%" content="" />
        </div>
    </form>
}