          ...
          <div className="frame background-white border-gray-06">
            ...
            <ol>
              <li>
                ...
                <ul>
                  <li>
                    ...
                    삭제되지 않으며, 작성자 명은{" "}
                    <span className="color-alert">탈퇴한 회원</span>으로 일괄
              ...
              <li>
                ...
                <ul>
                  <li>
                    회원 탈퇴 후, 재가입을 희망하실 경우 가능합니다. 다만,
                    재가입 시 새로운 아이디를 생성하는 과정을 거쳐야 하며, 이전
                    아이디로의{" "}
                    <span className="color-alert">복구는 불가능</span> 합니다.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    회원 탈퇴 시, 구글 이메일, 닉네임, 자기소개를 비롯한 개인
                    정보는 <span className="color-alert">모두 삭제</span>됩니다.
                    단, 특정 게시글은 탈퇴한 회원 형태로 남게 되며, 이는
                    커뮤니티의 토론 및 정보 공유의 연속성을 위해 필요한 최소한의
                    조치입니다.
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    탈퇴 후, 이전에 이용하셨던 이메일로는 동일한 아이디로
                    재가입이 불가능합니다. 재가입을 원하실 경우, 새로운 아이디
                    생성이 필요합니다.
                  </li>
                  <li>
                  ...
                  <li>
                    본 약관에 동의하실 경우, 아래의{" "}
                    <span className="color-alert">탈퇴 신청</span> 버튼을
                    클릭하여 탈퇴 절차를 진행해주시기 바랍니다. 탈퇴 과정에 대해
                    궁금한 점이 있으시다면, 언제든지 고객 지원 서비스를 통해
                    문의하실 수 있습니다.
                  </li>
                </ul>
              </li>
