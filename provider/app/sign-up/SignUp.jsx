    ...
    return (
        <form className={signupstyle["form-wrapper"]} onSubmit={handleSubmit}>
            <div className={signupstyle["form-button-area"]}>
                <input className={signupstyle["form-button"]} type="submit" value="저장하기" />
            </div>
            <div className={signupstyle["form-info"]}>
                <label className={signupstyle["form-label"]} htmlFor="nick">닉네임</label>
                <input className={signupstyle["form-text-field"]} type="text" name="nick" id="nick" placeholder="닉네임을 입력하세요" />
                <label className={signupstyle["form-label"]} htmlFor="phone_number">핸드폰번호</label>
                <input className={signupstyle["form-text-field"]} type="number" name="phone_number" id="phone_number" placeholder="'-' 없이 숫자만 입력해주세요." />
