...
import { updateApplicationTemplate } from "../../../actions";
...
export default function UpdateApplicationTemplateForm({
  ...
  const handleApplyForm = async (applicationTemplateForm) => {
    const { editorInstance } = editorRef.current;

    try {
      await updateApplicationTemplate({
        announcementId,
        detailId,
        title: applicationTemplateForm.get("title"),
